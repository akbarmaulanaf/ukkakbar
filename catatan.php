            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="judul-halaman mb-0 p-0 kuning">Catatan</h3>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <img src="gambar/open-book.png" alt="" width="50" style="margin-left: 450px;">
                                <h2>Catatan Perjalanan dari <?php echo $_SESSION['username'] ?></h2>
                                <div class="table-responsive">
                                    ...
                                    <table id="myTable" class="table user-table no-wrap">
                                        <thead>
                                            <tr>
                                                <th class="border-top-0" value='1'>Tanggal</th>
                                                <th class="border-top-0" value='2'>Waktu</th>
                                                <th class="border-top-0" value='3'>Lokasi</th>
                                                <th class="border-top-0" value='4'>Nama Customer</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
